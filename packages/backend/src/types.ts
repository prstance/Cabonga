...
export type { agendaDayType, authTokensType, profileType, schoolType, agendaType, agendaItemType, evaluationType, evaluationsType, lessonType, lessonsType, diaryItemType, diaryType, decodedAccessTokenType }